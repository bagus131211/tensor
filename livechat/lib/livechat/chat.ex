defmodule Livechat.Chat do
  ...
  def subscribe, do: Phoenix.PubSub.subscribe(Livechat.PubSub, @topic)
  ...
  def delete_message(%Message{} = message) do
    Repo.delete(message) |> notify_subs([:message, :deleted])
  end
  ...
  defp notify_subs({:error, reason}, _event), do: {:error, reason}
end
